...
class Gestion2Controller extends Zend_Controller_Action
{
	...
	*/
	...
	{
			$this->view->titulo = "Crear Producto Tintoreria";
			//***ejecuto la consulta
	...
	*/
		...
		public function modificarAction()
	   	{
	   		$this->contenidoPagina("Modificar Producto Tintoreria");
			$form = $this->getFormId();
			if ($form->isValid($_GET)) { //*** me llego el id del cliente
				$values = $form->getValues(); //*** obtengo los valores
				$pro = new Application_Model_productostintoreria;
